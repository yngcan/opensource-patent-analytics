...
In developing the WIPO Open Source Manual Patent Analysis Manual we will be using a number of tools. To get started you might want to download and sign up for some or all of the the following:
