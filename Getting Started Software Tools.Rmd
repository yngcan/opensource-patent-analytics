...
In developing the Open Source Manual we will be using a number of tools. To get started it you might want to download and sign up for some or all of the the following:

- Open Office
- Google Spreadsheets and Google Charts (Google Account)
- Open Refine
- Gephi
- RStudio
- Python
